    ...
    <div class="card-body login-card-body">
      ...
      <form action="{{ url('admin/login') }}" method="post">
        ...
        <div class="input-group mb-3">
          ...
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-envelope" style="color: #FD5814"></span>
            </div>
          </div>
        </div>
        <div class="input-group mb-3">
        ...
        <a href="{{url('admin/forget-password')}}">forgot password</a>
          ...
          <!-- /.col -->
         <div class="col-4">
            <button type="submit" class="btn btn btn-block" style="background-color: #FD5814;color: white !important">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
